	...
	public static void registerWorldEdit() {
		...
		if (Bukkit.getServer().getPluginManager().getPlugin("WorldEdit") != null) {
			...
			if (Bukkit.getPluginManager().getPlugin("PirateSK") != null) {
				Skript.registerEffect(EffPasteSchematic.class, new String[] {
			...
			Skript.registerEffect(EffSaveClipToSchematic.class,
					new String[] { "[sharpsk] [worldedit] save clipboard of %player% (to|as) [schem[atic]] %string%" });
			Skript.registerEffect(EffSaveSelectionToClipboard.class, new String[] {
