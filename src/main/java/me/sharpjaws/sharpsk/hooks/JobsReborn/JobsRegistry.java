...
public class JobsRegistry {
	...
	public static void registerJobs() {
		...
		EventValues.registerEventValue(JobsJoinEvent.class, Player.class, new Getter<Player, JobsJoinEvent>() {
			@Override
			@Nullable
		...
		EventValues.registerEventValue(JobsLeaveEvent.class, Player.class, new Getter<Player, JobsLeaveEvent>() {
			@Override
			@Nullable
		...
		EventValues.registerEventValue(JobsPaymentEvent.class, Player.class, new Getter<Player, JobsPaymentEvent>() {
			@Override
			@Nullable
		...
		EventValues.registerEventValue(JobsLevelUpEvent.class, Player.class, new Getter<Player, JobsLevelUpEvent>() {
			@Override
			@Nullable
		...
		if (Bukkit.getPluginManager().getPlugin("Jobs").getDescription().getVersion().matches("3.\\d.\\d")
			...
			Skript.registerExpression(ExprJobsofPlayer.class, Job.class, ExpressionType.SIMPLE,
					"[all] jobs of %offlineplayer%");
			Skript.registerExpression(ExprJobLevel.class, Integer.class, ExpressionType.SIMPLE,
					"[the] level of job %job% of %offlineplayer%");
		} else {
			Skript.registerExpression(ExprJobsofPlayerOld.class, Job.class, ExpressionType.PROPERTY,
					"[all] [the] jobs of %offlineplayer%");
			Skript.registerExpression(ExprJobLevelOld.class, Integer.class, ExpressionType.SIMPLE,
					"[the] level of job %job% of %offlineplayer%");
