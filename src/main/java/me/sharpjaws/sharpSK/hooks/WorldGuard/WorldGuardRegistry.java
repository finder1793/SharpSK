	...
	public static void registerWorldGuard(){
		//PirateSK merged features
				 Skript.registerEffect(EffCreateRegion.class,  "[sharpsk] [worldguard] create region %string% between %location% and %location% in [world] %world%" );
			       ...
			       Skript.registerEffect(EffAddOwner.class,  "[sharpsk] [worldguard] add owner[s] %players/offlineplayers/strings% [(-1在y name|1在y uuid)] to region %string% in [world] %world%" );
		   ...
		   Skript.registerExpression(ExprAllMembers.class, String.class, ExpressionType.SIMPLE,  "[sharpsk] [worldguard] [all] members of region %string% in [world] %world%" );
		   Skript.registerExpression(ExprAllOwners.class, String.class, ExpressionType.SIMPLE,  "[sharpsk] [worldguard] [all] owners of region %string% in [world] %world%" );
		   Skript.registerExpression(ExprAllFlagsOfRegion.class, String.class, ExpressionType.SIMPLE,  "[sharpsk] [worldguard] [all] flags of region %string% in [world] %world%" );
		   Skript.registerExpression(ExprFlagValueOfFlagOfRegion.class, String.class, ExpressionType.SIMPLE,  "[sharpsk] value of flag %string% of [worldguard] region %string% in [world] %world%" );
		   Skript.registerEvent("Worldguard PVP Disallowed Event",SimpleEvent.class, DisallowedPVPEvent.class, "[sharpsk] [worldguard] pvp disallow[ed]");
