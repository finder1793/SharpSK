...
public class ExprTownyEventTown extends SimpleExpression<String> {
	...
	public boolean init(Expression<?>[] expr, int matchedPattern, Kleenean arg2, ParseResult result) {
		if (!ScriptLoader.isCurrentEvent(TownAddResidentEvent.class) && !ScriptLoader.isCurrentEvent(TownRemoveResidentEvent.class) && !ScriptLoader.isCurrentEvent(RenameTownEvent.class) && !ScriptLoader.isCurrentEvent(DeleteTownEvent.class)&& !ScriptLoader.isCurrentEvent(NewTownEvent.class)) {
			return false ;		
		}
		return true;
	}
