...
public class LuckPermsRegistry {
	...
	public static void registerLuckPerms() {
		...
		//Effects		
		Skript.registerEffect(EffLuckPermsSetPerm.class, "[sharpsk] (luckperms|lp) set (-1¦transient perm[ission]|1¦perm[ission]) %string% to %boolean% for [player] %offlineplayer% [transient %-boolean%]");
		Skript.registerEffect(EffLuckPermsUnsetPerm.class, "[sharpsk] (luckperms|lp) unset (-1¦transient perm[ission]|1¦perm[ission]) %string% for [player] %offlineplayer%");
		...
		//Expressions
		Skript.registerExpression(ExprLuckPermsAllPermissionsOfPlayer.class, String.class, ExpressionType.SIMPLE, "[sharpsk] (luckperms|lp) [(all|the)] (-1¦transient perm[ission]s|1¦perm[ission]s) of %player%");
